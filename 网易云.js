      ...
      , q = l.BufferedBlockAlgorithm = t.extend({
        ...
        mP8H: function(a) {
            var c = this.i4m
              ...
              , k = this.blockSize
              , b = j / (4 * k)
              , b = a ? u.ceil(b) : u.max((b | 0) - this.Xs0x, 0);
            a = b * k;
            j = u.min(4 * a, j);
            if (a) {
                for (var q = 0; q < a; q += k)
    ...
    var p = CryptoJS
      ...
      , v = d.Cipher = t.extend({
        ...
        createEncryptor: function(e, a) {
            return this.create(this.Hk4o, e, a)
        },
...
(function() {
    ...
    var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
      , d = d.AES = p.extend({
        md7W: function() {
            for (var a = this.J4N, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.ZJ1x = d + 6) + 1), e = this.bsC5H = [], j = 0; j < a; j++)
                if (j < d)
                    e[j] = c[j];
                else {
                    var k = e[j - 1];
        ...
        encryptBlock: function(a, b) {
            this.Fh3x(a, b, this.bsC5H, t, r, w, v, l)
        },
        decryptBlock: function(a, c) {
            var d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d;
            this.Fh3x(a, c, this.bsH5M, b, x, q, n, s);
            d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d
        },
...
function start(id){
    var d =  {"ids":"["+id+"]","level":"standard","encodeType":"aac","csrf_token":"a4c5aabbdb05c59e612162108ab8c0ce"};
    var e = "010001";
    ...
    var bVj8b = window.asrsea(JSON.stringify(d),e, f,g);
    return bVj8b
}
console.log(start(''))

function start_id(name){
    var d = {"hlpretag":"<span class=\"s-fc7\">","hlposttag":"</span>","s":"["+name+"]","type":"1","offset":"0","total":"true","limit":"30","csrf_token":"a4c5aabbdb05c59e612162108ab8c0ce"};
    var e = "010001";
    var f = "";
    var g = "0CoJUm6Qyw8W8jud";
    var bVj8b = window.asrsea(JSON.stringify(d),e, f,g);
...
//"{\"logs\":\"[{\\\"action\\\":\\\"searchkeywordclient\\\",\\\"json\\\":{\\\"type\\\":\\\"song\\\",\\\"keyword\\\":\\\"李荣浩\\\",\\\"offset\\\":0,\\\"device_id\\\":\\\"null\\\"}}]\",\"csrf_token\":\"a4c5aabbdb05c59e612162108ab8c0ce\"}"
//d: "{\"hlpretag\":\"<span class=\\\"s-fc7\\\">\",\"hlposttag\":\"</span>\",\"s\":\"李荣浩\",\"type\":\"1\",\"offset\":\"0\",\"total\":\"true\",\"limit\":\"30\",\"csrf_token\":\"a4c5aabbdb05c59e612162108ab8c0ce\"}"
//d: "{\"csrf_token\":\"a4c5aabbdb05c59e612162108ab8c0ce\"}"
//d: "{\"resourcePositions\":\"MainTabFollow\",\"csrf_token\":\"a4c5aabbdb05c59e612162108ab8c0ce\"}"
//d: "{\"csrf_token\":\"a4c5aabbdb05c59e612162108ab8c0ce\"}"
// e: "010001"
// f: ""
// g: "0CoJUm6Qyw8W8jud"
//"{\"hlpretag\":\"<span class=\\\"s-fc7\\\">\",\"hlposttag\":\"</span>\",\"s\":\"李荣浩\",\"type\":\"1\",\"offset\":\"0\",\"total\":\"true\",\"limit\":\"30\",\"csrf_token\":\"a4c5aabbdb05c59e612162108ab8c0ce\"}"
